...
const versionRoute = {
    handler,
    // Serve both the bare endpoint and the Lavalink-style versioned alias so
    // clients polling /v4/version (startup health checks, moonlink, etc.) no
    // longer get 404s.
    paths: ['/version', '/v4/version']
};
